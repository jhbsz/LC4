...
# EZP: DEFAULT_PACKAGES:=base-files libgcc uclibc busybox dropbear mtd uci opkg
DEFAULT_PACKAGES:=base-files libgcc uclibc busybox dropbear 
# For router targets
...
LINUX_CONFCMD2=$(SCRIPT_DIR)/kconfig.pl + $(LINUX_DIR)/.config $(if $(LINUX_SUBCONFIG),+ $(LINUX_CONFIG) $(LINUX_SUBCONFIG),$(LINUX_CONFIG))
...
define BuildTargets/DumpCurrent
  ...
  dumpinfo:
	@echo 'Target: $(TARGETID)'; \
	 ...
	 echo 'Target-EZP-Platform: $(EZP_PLATFORM)'; \
	 echo 'Target-EZP-SWType: $(EZP_SWTYPE)'; \
