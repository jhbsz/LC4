...
ifneq ($(CONFIG_TARGET_ralink_7620),y)
...
$(eval $(call nf_add,IPT_IPOPT,CONFIG_IP_NF_MATCH_TTL, $(P_XT)xt_hl))
else
...
ifeq ($(CONFIG_TARGET_ralink_7620),y)
$(eval $(call nf_add,IPT_IPOPT,CONFIG_IP_NF_TARGET_TTL, $(P_XT)xt_HL))
else
...
$(eval $(call nf_add,IPT_CONNTRACK_EXTRA,CONFIG_NETFILTER_XT_MATCH_WEBSTR, $(P_XT)xt_webstr))
