...
WIRELESS_DIR?=$(LINUX_DIR)/drivers/net/wireless
...
define Kernel/Patch/Default
	...
	if [ -d $(FILES_DIR) ]; then \
		...
		rm -rf $(WIRELESS_DIR)/rt2860v2 $(WIRELESS_DIR)/rt2860v2_sta $(WIRELESS_DIR)/rt2860v2_ap; \
		 ln -sf $(WIRELESS_DIR)/rt2860v2_305x $(WIRELESS_DIR)/rt2860v2 && ln -sf $(WIRELESS_DIR)/rt2860v2_sta_305x $(WIRELESS_DIR)/rt2860v2_sta && ln -sf $(WIRELESS_DIR)/rt2860v2_ap_305x $(WIRELESS_DIR)/rt2860v2_ap; \
		[ ! -z "$$$$(echo $(SUBTARGET) | grep rt5350)" ] && rm -rf $(WIRELESS_DIR)/rt2860v2 $(WIRELESS_DIR)/rt2860v2_sta $(WIRELESS_DIR)/rt2860v2_ap; \
		[ ! -z "$$$$(echo $(SUBTARGET) | grep rt5350)" ] && ln -sf $(WIRELESS_DIR)/rt2860v2_5350 $(WIRELESS_DIR)/rt2860v2 && ln -sf $(WIRELESS_DIR)/rt2860v2_sta_5350 $(WIRELESS_DIR)/rt2860v2_sta && ln -sf $(WIRELESS_DIR)/rt2860v2_ap_5350 $(WIRELESS_DIR)/rt2860v2_ap; \
		[ ! -z "$$$$(echo $(SUBTARGET) | grep rt3883)" ] && rm -rf $(WIRELESS_DIR)/rt2860v2 $(WIRELESS_DIR)/rt2860v2_sta $(WIRELESS_DIR)/rt2860v2_ap; \
		[ ! -z "$$$$(echo $(SUBTARGET) | grep rt3883)" ] && ln -sf $(WIRELESS_DIR)/rt2860v2_3883 $(WIRELESS_DIR)/rt2860v2 && ln -sf $(WIRELESS_DIR)/rt2860v2_sta_3883 $(WIRELESS_DIR)/rt2860v2_sta && ln -sf $(WIRELESS_DIR)/rt2860v2_ap_3883 $(WIRELESS_DIR)/rt2860v2_ap; \
		[ ! -z "$$$$(echo $(SUBTARGET) | grep rt3352)" ] && rm -rf $(WIRELESS_DIR)/rt2860v2 $(WIRELESS_DIR)/rt2860v2_sta $(WIRELESS_DIR)/rt2860v2_ap; \
		[ ! -z "$$$$(echo $(SUBTARGET) | grep rt3352)" ] && ln -sf $(WIRELESS_DIR)/rt2860v2_3352 $(WIRELESS_DIR)/rt2860v2 && ln -sf $(WIRELESS_DIR)/rt2860v2_sta_3352 $(WIRELESS_DIR)/rt2860v2_sta && ln -sf $(WIRELESS_DIR)/rt2860v2_ap_3352 $(WIRELESS_DIR)/rt2860v2_ap; \
