...
#define SERV_MAC_SENSE                      (84)
#define ACTION_MAC_SENSE_STOP               (84)
#define ACTION_MAC_SENSE_START              (85)

#define SERV_SERIAL                      (86)
#define ACTION_SERIAL_STOP               (86)
#define ACTION_SERIAL_START              (87)
    
#define SERV_RELAY                      (88)
#define ACTION_RELAY_STOP               (88)
#define ACTION_RELAY_START              (89)
...
extern void als_status(char *, webs_t, ...);
...
#ifdef EZP_MAC_SENSE
/* for Mac sense */
extern int valid_mac_sense(webs_t wp, char *value, struct variable *v);
extern int save_mac_sense(webs_t wp, char *value, struct variable *v,
        struct service *s);
#endif

#if defined(PLATFORM_ALS)
/* for Allis */
extern int valid_als_func(webs_t wp, char *value, struct variable *v);
extern int save_als_func(webs_t wp, char *value, struct variable *v,
        struct service *s);
extern int command_save(webs_t wp, char *value, struct variable *v,
        struct service *s);
extern int valid_relay(webs_t wp, char *value, struct variable *v);
extern int save_relay(webs_t wp, char *value, struct variable *v,
        struct service *s);
extern int valid_alert(webs_t wp, char *value, struct variable *v);
extern int save_alert(webs_t wp, char *value, struct variable *v,
        struct service *s);
extern int valid_file_mode(webs_t wp, char *value, struct variable *v);
extern int save_file_mode(webs_t wp, char *value, struct variable *v,
        struct service *s);
#endif
...
extern int ej_do_als_week(int eid, webs_t wp, int argc, char_t ** argv);
extern int ej_do_als_time(int eid, webs_t wp, int argc, char_t ** argv);
/* Print */
