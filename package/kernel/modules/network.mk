...
define KernelPackage/gre
  SUBMENU:=$(NETWORK_SUPPORT_MENU)
  TITLE:=GRE support
  KCONFIG:=CONFIG_NET_IPGRE CONFIG_NET_IPGRE_BROADCAST=y
...
ifeq ($(CONFIG_TARGET_ralink_7620_mt7620_evb),y)
  PPP_FILES:= \
	$(LINUX_DIR)/drivers/net/ppp_async.$(LINUX_KMOD_SUFFIX) 
  PPP_AUTOLOAD:=$(call AutoLoad,30,crc-ccitt ppp_async)
else
ifeq ($(CONFIG_TARGET_ralink_7620_mt7620_als),y)
  PPP_FILES:= \
	$(LINUX_DIR)/drivers/net/ppp_async.$(LINUX_KMOD_SUFFIX) 
  PPP_AUTOLOAD:=$(call AutoLoad,30,crc-ccitt ppp_async)
else
  ...
  PPP_AUTOLOAD:=$(call AutoLoad,30,slhc crc-ccitt ppp_generic ppp_async)
endif
endif
