...
define KernelPackage/usb-serial-option-2-6-36
  $(call usbdep,kmod-usb-serial @LINUX_2_6_36)
  TITLE:=Support for Option HSDPA modems
  KCONFIG:= \
    CONFIG_USB_SERIAL_WWAN \
    CONFIG_USB_SERIAL_OPTION 
  FILES:= \
    $(LINUX_DIR)/drivers/usb/serial/usb_wwan.$(LINUX_KMOD_SUFFIX) \
    $(LINUX_DIR)/drivers/usb/serial/option.$(LINUX_KMOD_SUFFIX)
  AUTOLOAD:=$(call AutoLoad,65,usb_wwan option)
endef

define KernelPackage/usb-serial-option-2-6-36/description
 Kernel support for Option HSDPA modems
endef

$(eval $(call KernelPackage,usb-serial-option-2-6-36))

define KernelPackage/usb-serial-option
  $(call usbdep,kmod-usb-serial @LINUX_2_6 !@LINUX_2_6_36)
  TITLE:=Support for Option HSDPA modems
...
define KernelPackage/usb-storage
  ...
  AUTOLOAD:=$(call AutoLoad,60,scsi_mod usb-storage sd_mod)
endef
