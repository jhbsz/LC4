            ...
            <form name="form" action="apply.cgi" method="post">
              ...
              <fieldset>
                ...
                <div class="setting">
                  ...
                  <input type="radio" value="1" name="smbd_enable" onclick="init()"
                        <%nvg_attr_match("smbd_enable","smbd_rule","0","enable","1","checked");%>><%lang("Enable");%>
                  </input>

                  <input type="radio" value="0" name="smbd_enable" onclick="init()"
                ...
                <div class="setting">
                  ...
                  <input type="radio" value="1" name="smbd_guest_ok" onclick="init()"
                        <%nvg_attr_match("smbd_guest_ok","smbd_rule","0","guest_ok","1","checked");%>><%lang("Enable");%>
                  </input>

                  <input type="radio" value="0" name="smbd_guest_ok" onclick="init()"
                ...
                <div class="setting">
                  ...
                  <input type="radio" value="1" name="smbd_read_only" onclick="init()"
                        <%nvg_attr_match("smbd_read_only","smbd_rule","0","read_only","1","checked");%>><%lang("Enable");%>
                  </input>

                  <input type="radio" value="0" name="smbd_read_only" onclick="init()"
                ...
                <div class="setting">
                  ...
                  <input type="radio" value="1" name="smbd_ext_access" onclick="init()"
                        <%nvg_attr_match("smbd_ext_access","smbd_rule","0","ext_access","1","checked");%>><%lang("Enable");%>
                  </input>

                  <input type="radio" value="0" name="smbd_ext_access" onclick="init()"
