...
<div class='radiobutton'><input type="radio" value="1" name="guest_lan_enable"
    onchange="SelGuest(1)"
    <%nvg_attr_match("guest_lan_enable","guest_lan_rule","0","enable","1","checked");%>><%lang("Enable");%></input></div>
<div class='radiobutton'><input type="radio" value="0" name="guest_lan_enable" 
    onchange="SelGuest(1)"
    <%nvg_attr_match("guest_lan_enable","guest_lan_rule","0","enable","0","checked");%>><%lang("Disable");%></input></div>
</br> 
