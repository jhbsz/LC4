...
<div style='display:inline-block;'>
  ...
  <div class="setting">
    ...
    <select name="wan$0_wwan_mode"> 
      ...
      <option value="hsdpa" <% nvg_attr_match("wan$0_wwan_mode", "wan_wwan_rule", "$0", "mode", "hsdpa", "selected"); %>>HSPA / LTE / 4G</option>
  ...
  <div class="setting">
    ...
    <div class='radiobutton'><input type="radio" name="wan$0_wwan_turbolink" id="wan$0_wwan_turbolink"
