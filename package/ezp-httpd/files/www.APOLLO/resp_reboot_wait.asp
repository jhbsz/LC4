...
<html>
    ...
    <% do_pagehead2(); %>
        ...
        function waitstyle()
        {
            ...
            document.getElementById('waiting-window').style.left=get_left_offset(300);
...
.waiting-msg {
    ...
    <body onload='waitstyle();'>
        <div class="message">
                ...
                <div id='waiting-window' style='display:block;'>
                    <div class='widgetInfo'>
                        <br/>
                        <div><img src='style/images/radial.gif' width='202px' height='19px' /></div><br>
                        <span class='waiting-msg'>Rebooting... Please wait....</span>
