...
<html>
<head>
<title id="title"><% nv_get("model"); %> - <%lang("Internet Connection");%></title>
<% do_pagehead2(); %>
...
var msg = "<%lang("WG-C10 will reboot to connect to the selected network. The connection between WG-C10 and the wireless LAN will end, please reconnect after rebooting.");%>";
var WISPData = [];
...
$(document).ready(function(){
    ...
    jQuery('#wl0_surveyData').jqGrid({
        ...
        colModel:[
              ...
              {name:'active',index:'active', width:170, align:"center"}
            ],
        autowidth: 'auto',
        width: 'auto',
        height: 'auto',
  ...
  <body class="gui" onload="init();menuFreezer();"> <% showad(); %>
    ...
    <form id="wl0_SSIDForm" name="wl0_SSIDForm" action="apply.cgi" method="post" >
        ...
        <div id="wl0_surveyData-dialog" title="" style='display:none;'>
            <table id="wl0_SSIDTable">
                <tr><td align='right'><%lang("SSID");%>:</td><td><input type='text' name='wl0_apcli0_ssid' id='wl0_apcli0_ssid' value='' readonly/></td></tr>
                ...
                <tr><td align='right'><font id="sec_disable"><%lang("Security Mode");%></font>:</td><td><select name='wl0_apcli0_secmode' id='wl0_apcli0_secmode'>
                               <option value='disabled' ><%lang("Disable");%></option><option value='wep' >WEP</option><option value='psk' >WPA PSK (Pre-Shared Key)</option>
    ...
    <div id="wrapper">
      <div id="header">
        ...
        <% do_menu("Internet Connection", ""); %>
        <script type="text/javascript">do_header_post()</script>
      </div>
  
	  <script type="text/javascript">do_body_pre()</script>	
	  <script type="text/javascript">
        do_page_path('<%lang("Internet Connection");%>', '');
      </script>
      <div id="description"><%lang("With this set-up, you can use the internet while connecting your PC to Portable Wireless Server via Wireless LAN.");%> <br><br> <input type="button" id="wl0_survey" value="<%lang("Search");%>"></div>
