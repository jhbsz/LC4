...
$(document).ready(function(){
  ...
  <div class="setting">
    <div class="label"><font id="dns_ipaddr"><%lang("DNS server address");%></font></div>
 ...
 <div class="setting">
  ...
  <div class="setting">
    <div class="label"><font id="period"><%lang("Address lease period");%></font></div>
  ...
  <div class="setting">
    <div class="label"><font id="ip_pool"><%lang("IP Address pool");%></font></div>
  ...
  <div class="setting">
    <div class="label"><font id="dhcp_service"><%lang("DHCP Service");%></font></div>
  ...
  <div class="setting">
    <div class="label"><font id="dhcp_clients"><%lang("Max DHCP Clients");%></font></div>
 ...
 <div class="setting">
    <div class="label"><font id="domain"><%lang("Domain");%></font></div>
