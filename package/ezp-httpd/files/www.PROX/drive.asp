            ...
            <form name="form" action="apply.cgi" method="post">
              ...
              <fieldset>
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="drive_enable" onclick="init()"
                        <%nvg_attr_match("drive_enable","drive_rule","0","enable","1","checked");%>><%lang("Enable");%>
                  </input></div>

                  <div class='radiobutton'><input type="radio" value="0" name="drive_enable" onclick="init()"
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="drive_guest" onclick="init()"
                        <%nvg_attr_match("drive_guest","drive_rule","0","guest","1","checked");%>><%lang("Enable");%>
                  </input></div>

                  <div class='radiobutton'><input type="radio" value="0" name="drive_guest" onclick="init()"
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="drive_ext_access" onclick="init()"
                        <%nvg_attr_match("drive_ext_access","drive_rule","0","ext_access","1","checked");%>><%lang("Enable");%>
                  </input></div>

                  <div class='radiobutton'><input type="radio" value="0" name="drive_ext_access" onclick="init()"
