...
<%prod_show_html_start("hwnat", "0", "100");%>
              <fieldset>
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="hwnat_enable" onclick="init()"
                        <%nvg_attr_match("hwnat_enable", "nat_rule","0","hw_enable","1","checked");%>>
                    <%lang("Enable");%>
                  </input></div>

                  <div class='radiobutton'><input type="radio" value="0" name="hwnat_enable" onclick="init()"
...
<%prod_show_html_end("hwnat", "0", "100");%>
              <fieldset>
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="turbonat_enable" onclick="init()"
                        <%nvg_match("turbonat_enable","1","checked");%>>
                    <%lang("Enable");%>
                  </input></div>

                  <div class='radiobutton'><input type="radio" value="0" name="turbonat_enable" onclick="init()"
