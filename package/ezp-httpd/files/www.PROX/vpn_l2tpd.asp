            ...
            <form name="form" action="apply.cgi" method="post">
              ...
              <fieldset>
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="l2tpd_enable" onclick="init()"
                        <%nvg_attr_match("l2tpd_enable","l2tpd_rule","0","enable","1","checked");%>><%lang("Enable");%>
                  </input></div>

                  <div class='radiobutton'><input type="radio" value="0" name="l2tpd_enable" onclick="init()"
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="l2tpd_dns_auto_enable" onclick="init()"
                        <%nvg_attr_match("l2tpd_dns_auto_enable","l2tpd_rule","0","dns_auto_enable","1","checked");%>>
                        <%lang("Enable");%>
                  </input></div>
                  <div class='radiobutton'><input type="radio" value="0" name="l2tpd_dns_auto_enable" onclick="init()"
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="l2tpd_chap_enable" onclick="init()"
                        <%nvg_attr_match("l2tpd_chap_enable","l2tpd_rule","0","chap_enable","1","checked");%>>
                        <%lang("Enable");%>
                  </input></div>
                  <div class='radiobutton'><input type="radio" value="0" name="l2tpd_chap_enable" onclick="init()"
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="l2tpd_proxyarp_enable" onclick="init()"
                        <%nvg_attr_match("l2tpd_proxyarp_enable","l2tpd_rule","0","proxyarp_enable","1","checked");%>>
                        <%lang("Enable");%>
                  </input></div>
                  <div class='radiobutton'><input type="radio" value="0" name="l2tpd_proxyarp_enable" onclick="init()"
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="l2tpd_nat_enable" onclick="init()"
                        <%nvg_attr_match("l2tpd_nat_enable","l2tpd_rule","0","nat_enable","1","checked");%>>
                        <%lang("Enable");%>
                  </input></div>
                  <div class='radiobutton'><input type="radio" value="0" name="l2tpd_nat_enable" onclick="init()"
