...
function _local_create_input_field(T, nth) {
    ...
    s += "<div class='setting'>"
        ...
        + "<input type='hidden' id='vs_table_old_seq' value='"+nth+"' />"
        + "<input id='vs_table_seq' size='4' maxlength='4' value='"+nth+"' />"
        +"</div>";

    s += "<div class='setting'>"
        + "<div class='label'>"+'<%lang("Rule Name");%>' + "</div>"
    ...
    s += "<div class='setting'>"
        + "<div class='label'>"+'<%lang("External Interface");%>' + "</div>"
    ...
    s += "<div class='setting'>"
        ...
        + "<input id='wan_ipaddr' name='wan_ipaddr' size='17' maxlength='15' onblur='valid_ipaddr(this, \"IP\")' />"
        +"</div>";

    s += "<div class='setting'>"
        + "<div class='label'>"+'<%lang("Mapped LAN IP Address");%>' + "</div>"
        + "<input id='mapped_ipaddr' name='mapped_ipaddr' size='17' maxlength='15' onblur='valid_ipaddr(this, \"IP\")' />"
        +"</div>";
...
<body class="gui" onload="init();">
  <div id="wrapper">
      ...
      <script type="text/javascript">do_header_pre()</script>
        <% do_menu("Applications", "1-1 NAT"); %>
      <script type="text/javascript">do_header_post()</script>
      </div>

    <script type="text/javascript">do_body_pre()</script>	
    <script type="text/javascript">do_page_path('<%lang("Applications");%>', '<%lang("1-1 NAT");%>')</script>
    ...
    <script type="text/javascript">do_mainframe_pre()</script>	
        <div id="contentsInfo">
          <form name="form" action="apply.cgi" method="post">
            ...
            <fieldset>
              <legend><%lang("1-1 NAT");%></legend>
              <div class="setting">
                <div class="label"><% lang("1-1 NAT"); %></div>
            ...
            <fieldset>
              <legend><%lang("1-1 NAT Rule");%></legend>
