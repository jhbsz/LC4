        ...
        <div id="contentsInfo">
          <form name="form" action="apply.cgi" method="post" id= "setup">
            ...
            <fieldset>
              ...
              <div class="setting">
                <div class="label">
                  <% lang("Administrator Name"); %>
                </div><input maxlength="32" size=
                "30" name="http_admin" value='<%nvg_attr_get("http_admin", "http_rule", "0", "username");%>'>
              </div>
              ...
              <input type="hidden" value="1" name= "http_rmgt_enable"></input>
              <div class="setting">
                <div class="label">
