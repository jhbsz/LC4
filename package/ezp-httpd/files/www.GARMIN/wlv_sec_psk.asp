  ...
  <input type="hidden" name="wl$0_ssid$1_rekey_time_interval" value=
    '<% nvg_attr_get("wl$0_ssid$1_rekey_interval","wl$0_sec_wpa_rule","$1","rekey_interval");%>'>
...
<script type="text/javascript">
  document.write('<input type="text" name="wl$0_ssid$1_key" size="17" maxlength="64"');
