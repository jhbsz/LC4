<div>
  ...
  <div id="failover" class="setting" style="display:none">
    <div class="label"><%lang("FailOver");%></div>
    <input type="checkbox" name="wan$0_failover" id='wan$0_failover' <%nvg_attr_match("wan$0_failover","als_failover","$0","enable","on","checked");%>/> 
  </div>
