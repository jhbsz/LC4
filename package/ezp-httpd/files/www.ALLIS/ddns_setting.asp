  ...
  <fieldset>
    ...
    <%increase("$0", "1");%></legend>
      ...
      <div class="setting">
        <div class="label">
         ...
         <!-- <option value=
          ...
          <option value=
          "mgddns" <%nvg_attr_match("ddns$0_type","wan_ddns_rule","$0","type","mgddns","selected");%>>
          Mgddns.com
          </option>
        </select>
      </div>
      ...
      <div class="setting">
        <div class="label">
          <%lang("User Name");%>
        </div><input name="ddns$0_username" id="user_name" size="25" maxlength=
      ...
      <div class="setting">
        <div class="label">
          <%lang("Password");%>
        </div><input type="password" name="ddns$0_passwd" id="passwd" size="25"
      ...
      <div class="setting">
        <div class="label">
          <%lang("Host Name");%>
        </div><input name="ddns$0_hostname" size="25" id="hostname" maxlength=
        "128" onblur= "valid_name(this,'Host Name')" value=
        '<%nvg_attr_get("ddns$0_hostname","wan_ddns_rule","$0","hostname");%>'>.mgddns.com 
      </div>

      <div class="setting">
        <div class="label">
          <%lang("Update Time");%>
        </div><input name="ddns$0_server" size="25" id="server"  value=
        '<%nvg_attr_get("ddns$0_server","wan_ddns_rule","$0","server");%>'>(Min)
      </div>
<!--
      ...
      <div class="setting">
        ...
        <input type="button" name="ddns$0_update" id="ddns$0_update" 
                onclick="to_update_ddns()" value="<%lang("Update");%>" />
      </div>
-->
  </fieldset><br>
