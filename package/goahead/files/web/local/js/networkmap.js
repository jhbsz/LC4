$(document).ready(
	...
	$(".powersafe").click(function() {
		$("#b-title").html("<b>"+_("networkmap PowerSaving")+"</b>");
	...
	$(".bandwidth").click(function() {
		$("#b-title").html("<b>"+_("networkmap BandwidthMGMT")+"</b>");
	...
	$(".firewall").click(function() {
		$("#b-title").html("<b>"+_("networkmap Firewall")+"</b>");
	...
	$(".parental").click(function() {
		$("#b-title").html("<b>"+_("networkmap ParenetalControl")+"</b>");
	...
	// Game Engine click
	$(".game").click(function() {
		$("#b-title").html("<b>"+_("networkmap GameEngine")+"</b>");
	...
	$(".wireless").click(function() {
		$("#b-title").html("<b>"+_("networkmap WirelessSecurity")+"</b>");		
	...
	$(".popupmain").click(function() {
		$("#b-title").html("<b>Detail Information</b>");		
		$(".unit_bandwidth_icon").css('background-image','url(images/i_detail.gif)');
		var bH=$(window).height();
		var bW=$(window).width();
