...
<div class="close1"><a href="#" onclick="MM_showHideLayers('set_pupup1','','hide')"></a></div>
  ...
  <div align="right" style="margin-right:10px;"><a id="Finish" href="javascript: document.web_login.set_flag.value='1'; document.web_login.submit();"><span >Finish</span></a>  </div>
</li>
  </ul></div>
  <div id="set_pupup2">
<div class="close1"><a href="#" onclick="MM_showHideLayers('set_pupup2','','hide')"></a></div>
  ...
  <div align="right" style="margin-right:10px;"><a id="Finish" href="javascript: document.web_login.set_flag.value='2'; document.web_login.submit();"><span >Finish</span></a>  </div>
</li>
  </ul></div>
