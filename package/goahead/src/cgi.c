 ...
 */
	if (wp->cgiStdin == NULL) {
		wp->cgiStdin = websGetCgiCommName(wp);//Steve pacted 2010/05/26
	} 
	stdIn = wp->cgiStdin;
	stdOut = websGetCgiCommName(wp); //Steve pacted 2010/05/26
