...
#define IP_API \
    ...
    SW_API_DEF(SW_API_IP6_BASE_ADDR_SET, isis_ip6_base_addr_set), \
    SW_API_DEF(SW_API_IP6_BASE_ADDR_GET, isis_ip6_base_addr_get),
...
#define IP_API_PARAM \
    ...
    SW_API_DESC(SW_API_IP6_BASE_ADDR_SET) \
    SW_API_DESC(SW_API_IP6_BASE_ADDR_GET)
#else
#define IP_API
#define IP_API_PARAM
#endif
