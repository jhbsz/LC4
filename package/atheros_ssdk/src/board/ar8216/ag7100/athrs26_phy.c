...
sw_error_t athrs26_header_write(uint32_t dev_id, uint32_t reg_addr, uint8_t *reg_data, uint32_t len)
{
    athrs26_reg_write( reg_addr, *(uint32_t *)reg_data);
    return 0;
}

sw_error_t athrs26_header_read(uint32_t dev_id, uint32_t reg_addr, uint8_t *reg_data, uint32_t len)
{    
	  uint32_t data;

    data = athrs26_reg_read(reg_addr);
    *(uint32_t*)reg_data = data;
    return 0;
}
sw_error_t athrs26_phy_write(a_uint32_t dev_id, a_uint32_t phy_addr, a_uint32_t reg, a_uint16_t data)
{
...
sw_error_t athrs26_phy_read(a_uint32_t dev_id, a_uint32_t phy_addr, a_uint32_t reg, a_uint16_t *data)
{    
...
#ifdef FULL_FEATURE
{
    ...
    cfg.reg_func.mdio_set = athrs26_phy_write;
	cfg.reg_func.mdio_get = athrs26_phy_read;
    cfg.reg_func.header_reg_set = athrs26_header_write;
    cfg.reg_func.header_reg_get = athrs26_header_read;
