...
<div class="row">
    <div class="span12">
        ...
        <div class="row show-grid">
            <div class="span4"><% lang("Wireless Connection"); %></div>
            <div class="span8">
                <label class="radio inline">
                  <input type="radio" value="1" name= "wl$0_radio_enable" id= "wl$0_radio_enable" onclick='init()'
                    <%nvg_attr_match("wl$0_radio_enable", "wl_basic_rule", "$0", "enable", "1", "checked");%>><% lang("Enable"); %> </input>
                </label>
                <label class="radio inline">
                  <input type="radio" value="0" name= "wl$0_radio_enable" id= "wl$0_radio_enable" onclick='init()'
        ...
        <div class="row show-grid">
            <div class="span4"><% lang("Wireless Mode"); %></div>
            <div class="span8">
              <select name="wl$0_net_mode" id="wl$0_net_mode">
        ...
        <div class="row show-grid">
            <div class="span4"><% lang("Transmission Power"); %></div>
            <div class="span8">
              <select name="wl$0_txpower" id="wl$0_txpower">
  ...
  <%wlv_single_ssid_show_mark_begin();%>
        <div class="row show-grid">
            <div class="span4"><% lang("Wireless Isolation Between SSIDs"); %></div>
            <div class="span8">
                <label class="radio inline">
                  <input type="radio" value="1" name= "wl$0_bisolation_enable" id= "wl$0_bisolation_enable" onclick='init()'
                    <%nvg_attr_match("wl$0_bisolation_enable", "wl_basic_rule", "$0", "bisolation", "1", "checked");%>><% lang("Enable"); %> </input>
                </label>
                <label class="radio inline">
                  <input type="radio" value="0" name= "wl$0_bisolation_enable" id= "wl$0_bisolation_enable" onclick='init()'
