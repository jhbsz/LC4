...
<input type="hidden" name="ethernet_connection" value="<%nv_attr_get("cnnt_rule","0","connection");%>" />
<input type="hidden" name="ethernet_proto" value="<%nv_attr_get("cnnt_rule","0","proto");%>" />
<input type="hidden" name="wisp_connection" value="<%nv_attr_get("cnnt_rule","1","connection");%>" />
<input type="hidden" name="wisp_proto" value="<%nv_attr_get("cnnt_rule","1","proto");%>" />
<input type="hidden" name="usb_connection" value="<%nv_attr_get("cnnt_rule","2","connection");%>" />
<input type="hidden" name="usb_proto" value="<%nv_attr_get("cnnt_rule","2","proto");%>" />
<input type="hidden" name="plug_rule" value="<%nv_attr_get("plug_rule","0","wisp");%>" />
<input type="hidden" name="webdav_port" value="<%nv_attr_get("drive_rule","0","port");%>" />
<input type="hidden" name="allow_guest" value="<%nv_get("allow_guest");%>" />
<input type="hidden" name="mycloudnas_hn" value="<% show_mycloudnas_hn(); %>" />
</body>
