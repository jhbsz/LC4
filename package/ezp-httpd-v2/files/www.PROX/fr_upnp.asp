...
<html>
  ...
  <body class="gui" onload="init()"> <% showad(); %>
    <div id="wrapper">
	  ...
	  <script type="text/javascript">
            do_page_path('<%lang("Applications");%>', '<%lang("UPnP");%>')
      </script>
      <div id="contents">
        <form name="form" action="apply.cgi" method="post">
          ...
          <fieldset>
            ...
            <div class="setting">
              ...
              <div class='radiobutton'><input type="radio" value="1" name="upnp_enable" onclick="init()"
                    <% nvg_attr_match("upnp_enable", "upnp_rule", "0", "enable", "1", "checked"); %>>
                    <% lang("Enable"); %>
              </input></div>
              <div class='radiobutton'><input type="radio" value="0" name="upnp_enable" onclick="init()"
