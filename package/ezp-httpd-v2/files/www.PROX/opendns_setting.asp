...
<fieldset>
  <legend><%lang("OpenDNS");%> - <%lang("WAN");%> <%increase_wan("$0", "1");%></legend>

  <div class="setting">
    <div class="label"><%lang("OpenDNS Service");%></div>
    <div class='radiobutton'><input type="radio" value="1" name="opendns$0_enable" onclick="init()"
          <%nvg_attr_match("opendns$0_enable","wan_opendns_rule","$0","enable","1","checked");%>><%lang("Enable");%>
    </input></div>

    <div class='radiobutton'><input type="radio" value="0" name="opendns$0_enable" onclick="init()"
  ...
  <div class="setting">
    ...
    <div class='radiobutton'><input type="radio" value="1" name="opendns$0_redirect" onclick=""
    ...
    <div class='radiobutton'><input type="radio" value="0" name="opendns$0_redirect" onclick="init()"
