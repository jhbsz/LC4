            ...
            <fieldset>
              <legend><% lang("External Storage"); %></legend>
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="1" name="storage_ext_enable" onclick="init()"
                        <%nvg_attr_match("External Storage","storage_rule","0","ext_enable","1","checked");%>><%lang("Enable");%>
                  </input></div>

                  <div class='radiobutton'><input type="radio" value="0" name="storage_ext_enable" onclick="init()"
