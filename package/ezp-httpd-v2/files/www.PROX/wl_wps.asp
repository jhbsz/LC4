	        ...
	        <script type="text/javascript">do_hidden_elements('wl_wps_rule')</script>	
              <fieldset>
                ...
                <div class="setting">
                  ...
                  <div class='radiobutton'><input type="radio" value="7" id="wl_wps_enable" name="wl_wps_enable" onclick="init()"
                        <%nvg_attr_match("wps_enable", "wl_wps_rule","0","mode","7","checked");%>>
                    <%lang("Enable");%>
                  </input></div>

                  <div class='radiobutton'><input type="radio" value="0" name="wl_wps_enable" onclick="init()"
