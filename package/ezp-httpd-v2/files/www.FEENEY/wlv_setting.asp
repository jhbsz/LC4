...
<fieldset>
  <legend><%lang("WLAN");%> - <%lang("SSID");%> <%increase_org("$1","1");%></legend>
  ...
  <input type=radio name="wl$0_ssid$1_enable" value="1" onclick="wl_ssid_enable_disable(this.form, $0, $1)" 
    <%nvg_attr_match("wl$0_ssid$1_enable", "wl$0_basic_rule", "$1", "enable", "1", "checked");%>>
    <% lang("Enable"); %></input>
  <input type=radio name="wl$0_ssid$1_enable" value="0" onclick="wl_ssid_enable_disable(this.form, $0, $1)" 
  ...
  <input type=radio name="wl$0_ssid$1_hide" value="0" <%nvg_attr_match("wl$0_ssid$1_hide", "wl$0_basic_rule", "$1", "hidden", "0", "checked");%>><% lang("Enable"); %></input>
  <input type=radio name="wl$0_ssid$1_hide" value="1" <%nvg_attr_match("wl$0_ssid$1_hide", "wl$0_basic_rule", "$1", "hidden", "1", "checked");%>><% lang("Disable"); %></input>
  <br/>

  <div class="label"><%lang("Wi-Fi Multimedia");%> (WMM)</div>
  <input type=radio name="wl$0_ssid$1_wme_enable" value="1" <%nvg_attr_match("wl$0_ssid$1_wme_enable", "wl$0_basic_rule", "$1", "wme", "1", "checked");%>><% lang("Enable"); %></input>
  <input type=radio name="wl$0_ssid$1_wme_enable" value="0" <%nvg_attr_match("wl$0_ssid$1_wme_enable", "wl$0_basic_rule", "$1", "wme", "0", "checked");%>><% lang("Disable"); %></input>
  <br/>

  <div class="label"><%lang("Wireless Isolation");%></div>
  <input type=radio name="wl$0_ssid$1_isolation_enable" value="1" <%nvg_attr_match("wl$0_ssid$1_isolation_enable", "wl$0_basic_rule", "$1", "isolation", "1", "checked");%>><% lang("Enable"); %></input>
  <input type=radio name="wl$0_ssid$1_isolation_enable" value="0" <%nvg_attr_match("wl$0_ssid$1_isolation_enable", "wl$0_basic_rule", "$1", "isolation", "0", "checked");%>><% lang("Disable"); %></input>
  <br/>
