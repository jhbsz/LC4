<div>
  ...
  <div class="setting">
    ...
    <input type="radio" name="wan$0_wwan_demand" id="wan$0_wwan_demand"
      value="0" onclick="sel_wwan_ppp_mode('0', '$0')"
      <%nvg_attr_match("wan$0_wwan_demand","wan_wwan_rule","$0","demand","0","checked");%> />
      <%lang("Keep Alive");%>
    <input type="radio" name="wan$0_wwan_demand" id="wan$0_wwan_demand"
      value="1" onclick="sel_wwan_ppp_mode('1', '$0')" 
      <%nvg_attr_match("wan$0_wwan_demand","wan_wwan_rule","$0","demand","1","checked");%> />
      <%lang("On Demand");%>
  </div>

  <div class="setting">
    <div class="label"> <%lang("Max Idle Time");%> </div>
    <input class="num" size="4" maxLength="4" name="wan$0_wwan_idletime" id="wan$0_wwan_idletime"
        value='<%nvg_attr_get("wan$0_wwan_idletime", "wan_wwan_rule", "$0", "idletime");%>' 
