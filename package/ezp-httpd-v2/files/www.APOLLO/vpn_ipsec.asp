...
*/
    if (/*rule[enum_ipsec._ADV] ==*/ 1) {
        ...
        s += "<div class='isetting'>"
            ...
            + "<div class='iInputField'><input id='phase1_left_id' name='phase1_left_id' size='17' maxlength='15' onblur='' /></div>"
            +"</div><br/>";

        s += "<div class='isetting'>"
            + "<div class='ilabel'>"+'<%lang("Phase 1 Remote ID");%>' + "</div>"
            + "<div class='iInputField'><input id='phase1_right_id' name='phase1_remote_id' size='17' maxlength='15' onblur='' /></div>"
            +"</div><br/>";
