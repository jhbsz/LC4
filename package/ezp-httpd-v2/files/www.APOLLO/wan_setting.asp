...
[ { name: 'wan$0_proto' }, 
  ...
  { name: 'wan$0_wisp_ip_type', type: 'radio' },
...
<fieldset>
  ...
  <div class="setting">
    ...
    <div class='radiobutton'><input type="radio" value="1" name="wan$0_enable" onclick="init()"
          <%nvg_attr_match("wan$0_enable","wan_main_rule","$0","enable","1","checked");%>> <%lang("Enable");%>
    </input></div>

    <div class='radiobutton'><input type="radio" value="0" name="wan$0_enable" onclick="init()"
  ...
  <div class="setting">
    <div class="label"><% lang("PPTP VPN Client"); %></div>
    <div class='radiobutton'><input type="radio" value="1" name="wan$0_vpnc_enable" onchange="SelWAN(this.form)"
          <%nvg_attr_match("wan$0_vpnc_enable","wan_pptp_l2tp_rule","$0","enable","1","checked");%>>
    <%lang("Enable");%>
    </input></div>

    <div class='radiobutton'><input type="radio" value="0" name="wan$0_vpnc_enable" onchange="SelWAN(this.form)"
          <%nvg_attr_match("wan$0_vpnc_enable","wan_pptp_l2tp_rule","$0","enable","0","checked");%>>
    <%lang("Disable");%>
    </input></div>
  </div>
