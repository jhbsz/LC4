...
<fieldset>
  ...
  <div class='radiobutton'><input type="radio" value="1" name= "wl$0_radio_enable" onclick='init()'
    <%nvg_attr_match("wl$0_radio_enable", "wl_basic_rule", "$0", "enable", "1", "checked");%>><% lang("Enable"); %> </input></div>
  <div class='radiobutton'><input type="radio" value="0" name= "wl$0_radio_enable" onclick='init()'
    <%nvg_attr_match("wl$0_radio_enable", "wl_basic_rule", "$0", "enable", "0", "checked");%>><% lang("Disable"); %> </input></div>
  <br/>
  ...
  <div class='radiobutton'><input type="radio" value="1" name= "wl$0_bisolation_enable" onclick='init()'
    <%nvg_attr_match("wl$0_bisolation_enable", "wl_basic_rule", "$0", "bisolation", "1", "checked");%>><% lang("Enable"); %> </input></div>
  <div class='radiobutton'><input type="radio" value="0" name= "wl$0_bisolation_enable" onclick='init()'
    <%nvg_attr_match("wl$0_bisolation_enable", "wl_basic_rule", "$0", "bisolation", "0", "checked");%>><% lang("Disable"); %> </input></div>
  <br/>
