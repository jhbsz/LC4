...
value='<% nvg_attr_get("ddns$0_server_org","wan_ddns_rule","$0","server");%>'>
  ...
  <fieldset>
    ...
    <%lang("WAN");%>
    <%increase_wan("$0", "1");%></legend>

      <div class="setting">
        <div class="label">
          <%lang("DDNS Service");%>
        </div>
        <div class='radiobutton'><input type="radio" value="1" name="ddns$0_enable"
        onclick=
        "init()" <%nvg_attr_match("ddns$0_enable","wan_ddns_rule","$0","enable","1","checked");%>><%lang("Enable");%></div>
        <div class='radiobutton'><input type="radio" value="0" name="ddns$0_enable" onclick=
        "init()" <%nvg_attr_match("ddns$0_enable","wan_ddns_rule","$0","enable","0","checked");%>><%lang("Disable");%></div>
      </div>
