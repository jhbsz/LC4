<fieldset>
    ...
    <div class="setting">
      ...
      <div class="label"><%lang("Netmask");%></div>
        <select name="lan$0_static_mask">
          <option value="8" <%nvg_attr_match("lan$0_static_mask","lan_static_rule","$0","mask","8","selected");%>>
                255.0.0.0</option>
  ...
  <div class="setting">
    ...
    <div class='radiobutton'><input type="radio" value="1" name="lan$0_stp"
        <%nvg_attr_match("lan$0_stp","lan_main_rule","$0","stp","1","checked");%>><%lang("Enable");%></div>
    <div class='radiobutton'><input type="radio" value="0" name="lan$0_stp"
        <%nvg_attr_match("lan$0_stp","lan_main_rule","$0","stp","0","checked");%>><%lang("Disable");%></div>
  </div>
