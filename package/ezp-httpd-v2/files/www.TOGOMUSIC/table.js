...
function tbl_hide_pop_window(T) {
    ...
    E(T+'-input-window-wrapper').style.display = 'none';
    E(T+'-input-window-wrapper-wrapper').style.display = 'none';
}
...
function tbl_show_pop_window(T) {
    ...
    E(T+'-input-window').style.display = 'inline-block';
    E(T+'-input-window-wrapper').style.display = 'block';
    E(T+'-input-window-wrapper-wrapper').style.display = 'table-cell';
}
