<div class="row">
    <div class="span12">
        ...
        <div class="row show-grid">
            <div class="span4"><%lang("Internal IP Address");%></div>
            <div class="span8">
                  <input type="text" maxLength="15" size="16" name="lan$0_static_ipaddr" id="lan$0_static_ipaddr"
        ...
        <div class="row show-grid">
            ...
            <div class="span8">
                <select name="lan$0_static_mask" id="lan$0_static_mask">
    ...
    <input type="hidden" name="lan$0_static_gateway" id="lan$0_static_gateway" value='<%nv_attr_get("lan_static_rule", "$0", "gateway");%>' />
    <input type="hidden" name="lan$0_static_dns" id="lan$0_static_dns" value='<%nv_attr_get("lan_static_rule", "$0", "dns");%>' />
    <input type="hidden" name="lan$0_static_wins" id="lan$0_static_wins" value='<%nv_attr_get("lan_static_rule", "$0", "wins");%>' />

        <div class="row show-grid">
            <div class="span4"><%lang("Spanning Tree Protocol");%> (STP) </div>
            <div class="span8">
        ...
        <div class="row show-grid">
            ...
            <div class="span8">
                  <input type="text" size="6" maxLength="4" name="lan$0_mtu" id="lan$0_mtu"
                        value='<%nvg_attr_get("lan$0_mtu", "lan_main_rule", "$0", "mtu");%>'
                        onblur='valid_number(this, "MTU")' /> <%lang("Bytes");%>
            </div>
        </div>
  <input type="hidden" name="lan$0_weight" id="lan$0_weight" value="1"/>
