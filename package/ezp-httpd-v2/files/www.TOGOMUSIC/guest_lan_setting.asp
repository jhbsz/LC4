...
[ { name: 'guest_lan_ipaddr' },
  { name: 'guest_lan_mask' }
        ...
        <div class="row show-grid">
            <div class="span4"><% lang("Guest LAN"); %></div>
            <div class="span8">
                <label class="radio inline">
                    <input type="radio" value="1" name="guest_lan_enable" id="guest_lan_enable"
                        onchange="SelGuest(1)"
                        <%nvg_attr_match("guest_lan_enable","guest_lan_rule","0","enable","1","checked");%>> <%lang("Enable");%>
                </label>
                <label class="radio inline">
                    <input type="radio" value="0" name="guest_lan_enable" id="guest_lan_enable" 
                        onchange="SelGuest(1)"
        ...
        <div class="row show-grid">
            <div class="span4"><%lang("Guest LAN IP Address");%></div>
            <div class="span8">
                <input type="text" maxLength="15" size="16" name="guest_lan_ipaddr" id="guest_lan_ipaddr"
        ...
        <div class="row show-grid">
            <div class="span4"><%lang("Guest LAN Netmask");%></div>
            <div class="span8">
                <select name="guest_lan_mask" id="guest_lan_mask">
