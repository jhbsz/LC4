...
<%prod_show_html("start", "lb");%>
  ...
  <div class="setting" id="wan$0_maxcount">
    <div class="label"><%lang("Wait Time");%></div>
    <input type="num" name="wan$0_maxcount" size="2" maxlength="2" 
            value='<%nvg_attr_get("wan$0_maxcount", "wan_main_rule", "$0", "maxcount");%>'
            />
    </input>
  </div>
