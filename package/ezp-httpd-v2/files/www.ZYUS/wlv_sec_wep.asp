...
<script type="text/javascript">
  document.write('<input type="password" name="wl$0_ssid$1_key1" size="17" maxlength="32"');
...
<script type="text/javascript">
  document.write('<input type="password" name="wl$0_ssid$1_key2" size="17" maxlength="32"');
...
<script type="text/javascript">
  document.write('<input type="password" name="wl$0_ssid$1_key3" size="17" maxlength="32"');
...
<script type="text/javascript">
  document.write('<input type="password" name="wl$0_ssid$1_key4" size="17" maxlength="32"');
