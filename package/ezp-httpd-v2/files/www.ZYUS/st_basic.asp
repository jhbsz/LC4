...
-->
                ...
                <div id='bit_logo'></div>
                <a href='http://www.bitdefender.com/zyxel'>
                <div style="font-size:11px;font-weight: bold;color:black;">Get Free Internet Security Protection and Special Offer</div></a>
                </td>
                </table>
              </fieldset> <br />
              <%st_show_wan_setting();%>
              <%st_show_lan_setting();%>
              <%prod_show_html_start("PROD_CAT_M|PROD_CAT_N|PROD_CAT_P|PROD_CAT_C|PROD_CAT_D|PROD_CAT_K|PROD_CAT_U", "0", "6");%>
              <%st_show_wl_setting();%>
              <%prod_show_html_end("PROD_CAT_M|PROD_CAT_N|PROD_CAT_P|PROD_CAT_C|PROD_CAT_D|PROD_CAT_K|PROD_CAT_U", "0", "6");%>
