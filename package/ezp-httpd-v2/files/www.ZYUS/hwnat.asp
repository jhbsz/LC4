...
<html>
<head>
<title><% nv_get("model"); %> - Hardware Accelerator</title>
<% do_pagehead2(); %>
  ...
  <body class="gui" onload="init();"> <% showad(); %>
    <div id="wrapper">
      <div id="header">
        ...
        <% do_menu("Bandwidth", "Hardware Accelerator"); %>
        <script type="text/javascript">do_header_post()</script>
      </div>
  
	  <script type="text/javascript">do_body_pre()</script>	
	  <script type="text/javascript">
        do_page_path('<%lang("Bandwidth");%>', '<%lang("Hardware Accelerator");%>')
      </script>
	  ...
	  <script type="text/javascript">do_mainframe_pre()</script>	
          <div id="contentsInfo">
            <form name="form" action="apply.cgi" method="post">
              ...
              <fieldset>
                <input type="hidden" name="turbonat_enable" value="0"/>
                <legend><%lang("Hardware Accelerator");%></legend>
                <div class="setting">
                  <div class="label"><% lang("Hardware Accelerator"); %></div>
