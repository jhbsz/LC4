...
<html>
  <head>
    <title><% nv_get("model"); %> - <%lang("Security");%></title>
    <% do_pagehead2(); %>
...
function valid_wl_sec_wpa_radius_port(key, Message) {
  ...
  <body class="gui" onload="init();menuFreezer();">
    <div id="wrapper">
      ...
      <div id="description">
	  <%lang("You can set a password for wireless LAN connection.");%>
	  <br>
	  <table width="100%">
	  <tr>
	   <td width="5%">
        ...
        <div id="contentsInfo">
          <form name="form" action="apply.cgi" method="post" id="wireless">
            ...
            <div class="submitFooter">
              <input type="reset" value="<%lang("Cancel");%> "onClick="window.location.href='wl_basic.asp'" />
              <input type="button" name="save_button" value="<%lang("Save");%>" 
