            ...
            <form name="form" action="apply.cgi" method="post">
              ...
              <fieldset>
                ...
                <div class="setting">
                  ...
                  <input type="radio" value="1" name="tos_enable" onclick="init()"
                        <%nvg_attr_match("tos_enable", "tos_rule", "0", "enable", "1", "checked");%>><%lang("Enable");%>
                  </input>
                  <input type="radio" value="0" name="tos_enable" onclick="init()"
              ...
              <fieldset>
                ...
                <div class="setting">
                  ...
                  <input type="radio" value="1" name="tos_check_enable" 
                        <%nvg_attr_match("tos_check_enable", "tos_rule", "0", "check_enable", "1", "checked");%>><%lang("Enable");%>
                  </input>
                  <input type="radio" value="0" name="tos_check_enable" 
