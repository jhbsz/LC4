...
[ { name: 'wl$0_ssid$1_ssid' },
  ...
  <input type=radio name="wl$0_ssid$1_wme_enable" id="wl$0_ssid$1_wme_enable" value="1" <%nvg_attr_match("wl$0_ssid$1_wme_enable", "wl$0_basic_rule", "$1", "wme", "1", "checked");%>><% lang("Enable"); %></input>
  <input type=radio name="wl$0_ssid$1_wme_enable" id="wl$0_ssid$1_wme_enable" value="0" <%nvg_attr_match("wl$0_ssid$1_wme_enable", "wl$0_basic_rule", "$1", "wme", "0", "checked");%>><% lang("Disable"); %></input>
  <br/>

  <div class="label"><%lang("Wireless Isolation");%></div>
  <input type=radio name="wl$0_ssid$1_isolation_enable" id="wl$0_ssid$1_isolation_enable" value="1" <%nvg_attr_match("wl$0_ssid$1_isolation_enable", "wl$0_basic_rule", "$1", "isolation", "1", "checked");%>><% lang("Enable"); %></input>
  <input type=radio name="wl$0_ssid$1_isolation_enable" id="wl$0_ssid$1_isolation_enable" value="0" <%nvg_attr_match("wl$0_ssid$1_isolation_enable", "wl$0_basic_rule", "$1", "isolation", "0", "checked");%>><% lang("Disable"); %></input>
  <br/>
  </div>
  ...
  <option value="psk" <%nvg_attr_match("wl$0_ssid$1_secmode", "wl$0_sec_rule", "$1", "secmode", "psk", "selected");%>><% lang("WPA"); %></option>
  <option value="psk2" <%nvg_attr_match("wl$0_ssid$1_secmode", "wl$0_sec_rule", "$1", "secmode", "psk2", "selected");%>><% lang("WPA2"); %></option>
  </select><br>
  <div class="label">&nbsp</div> <div style="color: red;">( <% lang("It's recommended to use WPA2 for security."); %> )</div>
