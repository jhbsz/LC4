...
<%prod_show_html_start("vpnc", "0", "7");%>
  <div class="setting">
    <div class="label"><% lang("VPN Client"); %></div>
    <input type="radio" value="1" name="wan$0_vpnc_enable" onchange="SelWAN(this.form)"
          <%nvg_attr_match("wan$0_vpnc_enable","wan_pptp_l2tp_rule","$0","enable","1","checked");%>>
    <%lang("Enable");%>
    </input>

    <input type="radio" value="0" name="wan$0_vpnc_enable" onchange="SelWAN(this.form)"
