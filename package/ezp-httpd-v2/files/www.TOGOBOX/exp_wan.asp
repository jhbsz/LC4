...
<html>
<head>
<title><% nv_get("model"); %> - <%lang("Internet Connection");%></title>
<% do_pagehead2(); %>
    ...
    <form id="wl0_SSIDForm" name="wl0_SSIDForm" action="apply.cgi" method="post" >
        ...
        <div id="wl0_surveyData-dialog" title="" style='display:none;'>
            <table id="wl0_SSIDTable">
                ...
                <tr class="css_wep"><td align='right'><%lang("Change Password");%>:</td><td>
                ...
                <tr class="css_notwep"><td align='right'><%lang("Change Password");%>:</td><td>
