...
#ifdef RT2860
#define RTMP_DRV_NAME	"rt2860" xdef_to_str(RT28xx_MODE)
#define RT_CHIPSET		2860
RTMP_DECLARE_DRV_OPS_FUNCTION(2860);
#define RTMP_DRV_OPS_FUNCTION				RTMP_DRV_OPS_FUNCTION_BODY(2860)
#define RTMP_BUILD_DRV_OPS_FUNCTION_BODY	RTMP_BUILD_DRV_OPS_FUNCTION(2860)
#endif /* RT2860 */


#ifdef RT2880
#define RTMP_DRV_NAME	"rt2880" xdef_to_str(RT28xx_MODE)
#define RT_CHIPSET		2880
RTMP_DECLARE_DRV_OPS_FUNCTION(2880);
#define RTMP_DRV_OPS_FUNCTION				RTMP_DRV_OPS_FUNCTION_BODY(2880)
#define RTMP_BUILD_DRV_OPS_FUNCTION_BODY	RTMP_BUILD_DRV_OPS_FUNCTION(2880)
#endif /* RT2880 */
