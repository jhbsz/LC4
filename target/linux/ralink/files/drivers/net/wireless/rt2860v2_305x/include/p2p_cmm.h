...
#define P2P_SCAN_PERIOD					200	/* unit : 100ms. Scan period how long ? 2min ? */
...
typedef struct _P2P_COUNTER_STRUCT 
{
	...
	ULONG		ListenIntervalBias;	/* for some important action that need more dwell time in scan channel, add this Bias. Unit : 100 TU */
...
/*	UCHAR						PortNumber; */		/* the port number that is P2P. */
	ULONG						MyIp;
...
/*	HANDLE		P2pEvent; */		/* this event is created in UI.  informing driver by RT_OID_SET_P2P_EVENT */
	BOOLEAN						bIntraBss;
	BOOLEAN						bExtListen;
...
/*	RALINK_TIMER_STRUCT						P2pStopGoTimer; */
/*	RALINK_TIMER_STRUCT						P2pStopClientTimer; */
