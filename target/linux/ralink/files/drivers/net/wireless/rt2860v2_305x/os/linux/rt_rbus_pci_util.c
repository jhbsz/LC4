...
/*	POS_COOKIE pObj = (POS_COOKIE)pAd->OS_Cookie; */
	...
	*VirtualAddress = (PVOID)pci_alloc_consistent(pPciDev,sizeof(char)*Length, PhysicalAddress);
...
/*	POS_COOKIE pObj = (POS_COOKIE)pAd->OS_Cookie; */
	...
	pci_free_consistent(pPciDev, Length, VirtualAddress, PhysicalAddress);
}
...
/*	pObj = (POS_COOKIE)pAd->OS_Cookie; */
	...
	{
		return pci_map_single(pPciDev, ptr, size, direction);
	}
...
/*	pObj = (POS_COOKIE)pAd->OS_Cookie; */
	...
	if (size > 0)
		pci_unmap_single(pPciDev, dma_addr, size, direction);
