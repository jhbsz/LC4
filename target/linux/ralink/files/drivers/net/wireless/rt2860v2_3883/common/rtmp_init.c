	...
	IN	PRTMP_ADAPTER	pAd)
{
	...
	if ((pAd->RfIcType == RFIC_2020) || (pAd->RfIcType == RFIC_3020) 
		|| (pAd->RfIcType == RFIC_3320) || IS_RT5390(pAd))
...
/*		pAd->bTest1 = TRUE;*/
	...
	if (((NicConfig2.field.DynamicTxAgcControl == 1) && 
            ...
            (!IS_RT3352(pAd)) && (!IS_RT5350(pAd)) && (!IS_RT5390(pAd))))
	{
		/*
