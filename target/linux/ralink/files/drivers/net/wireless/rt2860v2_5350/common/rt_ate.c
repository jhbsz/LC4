...
{    
	...
	{
		DBGPRINT(RT_DEBUG_ERROR, ("Not support TSSI calibration since not 3370/3390/3350/3352 chip !!!\n"));
		return FALSE;
	}
	else
	{                              
...
{    
	...
	if ((!IS_RT3350(pAd)) && (!IS_RT3352(pAd)) && (!IS_RT3390(pAd)))                                
	{
		DBGPRINT(RT_DEBUG_ERROR, ("Not support TSSI calibration since not 3370/3390/3350/3352 chip or EEPROM not set!!!\n"));
		return FALSE;
	}
