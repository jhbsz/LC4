...
#if defined(CONFIG_RT_3052_ESW) || defined(CONFIG_AR8316) || defined(CONFIG_AR8328)
	esw_reg reg;
#endif
...
void fe_sw_init(void)
{
	...
	#endif
	#if defined (CONFIG_AR8328)
	/* first, we need to set the external of P5 to 0x0 */
        *(unsigned long *)(0xb01100C8) &= 0xe0ffffff;
        /* call initial function of AR8328 GigaSW */
    // athrs17_reset();
    // udelay(100000);
	athrs17_init();
	printk("\n AR8328 Giga Switch support \n");
	athrs17_LAN_WAN_Par();
	printk("\n AR8328 VLAN support \n");
	#endif
#endif
