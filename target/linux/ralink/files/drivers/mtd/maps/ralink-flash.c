...
#endif // defined (CONFIG_MTD_NNOR_RALINK) || defined (CONFIG_MTD_ANY_RALINK)

#if defined (CONFIG_MTD_NNOR_RALINK) || defined (CONFIG_MTD_ANY_RALINK)
...
/* EZP: SDK3600 module_init(rt2880_mtd_init); */
