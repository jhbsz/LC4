...
/* D-Link uses ignorance to switch. */
UNUSUAL_DEV( 0x1186, 0x3e04, 0x0001, 0x0001,
		"Dlink",
		"DWM-652",
		US_SC_DEVICE, US_PR_DEVICE, NULL,
		US_FL_IGNORE_DEVICE),

UNUSUAL_DEV( 0x07d1, 0x3e02, 0x0001, 0x0001,
		"Dlink",
		"DWM-156",
		US_SC_DEVICE, US_PR_DEVICE, NULL,
		US_FL_IGNORE_DEVICE ),
...
/* EZP: Amoi H01 uses the same VID/PID for storage and serial. */
