...
static INT bcm_ndo_init(struct net_device *dev)
{
    printk(" ========= bcm_init (noop) ======== ");
    return 0;
}

void bcm_ndo_uninit(struct net_device *dev)
{
    printk(" %s %s ========= bcm_uninit (noop) ======== ", __FILE__, __FUNCTION__);
    return;
}
...
{
//    .ndo_priv = Adapter,
    .ndo_init = bcm_ndo_init,
    .ndo_uninit = bcm_ndo_uninit,
    .ndo_open = bcm_open,
    .ndo_stop = bcm_close,
